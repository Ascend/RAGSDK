...
def split_text(
    ...
    for sentence, token_count in zip(sentences, n_tokens):
        ...
        if token_count > max_tokens:
            cal_chunks_when_exceed_max_tokens(chunks, max_tokens, overlap, sentence, tokenizer)
...
def cal_chunks_when_exceed_max_tokens(chunks, max_tokens, overlap, sentence, tokenizer):
    """
    超过最大tokens限制时的处理
    """
