...
def rag_init():
    ...
    parse.add_argument(
        "--embedding_path", type=str, default="/home/data/bge-large-zh-v1.5", help="embedding模型本地路径"
    )
    parse.add_argument(
        "--embedding_url", type=str, default="http://127.0.0.1:8080/embed", help="使用TEI服务化的embedding模型url地址"
    )
    ...
    parse.add_argument(
        "--reranker_path", type=str, default="/home/data/bge-reranker-large", help="reranker模型本地路径"
    )
    parse.add_argument(
        "--reranker_url", type=str, default="http://127.0.0.1:8080/rerank", help="使用TEI服务化的embedding模型url地址"
    )
