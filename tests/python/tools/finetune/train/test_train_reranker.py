...
from mx_rag.tools.finetune.train.train_reranker import train_reranker


class TestTrainReranker(unittest.TestCase):
    class Result:
    ...
    def test_run_success(self, fake_run, fake_check, fake_dir_check):
        ...
        train_reranker("test_reranker_path", "test_new_reranker_path", "dataset_path")
