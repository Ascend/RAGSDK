...
from mx_rag.tools.finetune.dataprocess.generate_qd import generate_qa_embedding_pairs, GENERATE_QA_PROMPT
...
class TestGenerateQD(unittest.TestCase):
    ...
    def test_run_success(self, chat):
        ...
        qd = generate_qa_embedding_pairs(llm, ["hello"], GENERATE_QA_PROMPT, 1)
