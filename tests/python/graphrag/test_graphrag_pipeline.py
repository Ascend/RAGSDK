...
class TestGraphRAGPipeline(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.node_vector_store = MilvusDB.create(client=client, x_dim=1024)
    ...
    def tearDown(self):
        ...
        self.node_vector_store.drop_collection()
    ...
    def test_as_retriever_success(self, mock_graph_rag_model, mock_storage_factory, mock_check_space):
    ...
    def test_as_retriever_invalid_parameters(self):
        ...
        with contextlib.ExitStack() as stack:
            stack.enter_context(patch('mx_rag.graphrag.graphrag_pipeline.check_disk_free_space', return_value=False))
            stack.enter_context(patch('mx_rag.graphrag.graphrag_pipeline.FileCheck.check_input_path_valid'))
            stack.enter_context(patch('mx_rag.graphrag.graphrag_pipeline.FileCheck.check_filename_valid'))
