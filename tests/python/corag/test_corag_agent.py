...
class TestCoRagAgent(unittest.TestCase):
    ...
    def test_corag_agent_init(self):
    ...
    @patch('mx_rag.corag.corag_agent.search_by_retrieve_api')
    ...
    def test_sample_path(self, mock_get_intermediate_prompt, mock_get_subquery_prompt, mock_search):
        ...
        mock_search.return_value = [
            {"text": "Paris is the capital city of France.", "id": "doc1"}
        ]
