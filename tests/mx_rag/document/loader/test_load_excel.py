...
class TestExcelLoader(unittest.TestCase):
    ...
    def test_call_load_xls(self, mock_load_xls):
        # Arrange
        loader = ExcelLoader("D:\\project\\mxRAG\\tests\\mx_rag\\document\\loader\\files\\test.xls")
        loader.load()
    ...
    def test_call_load_xlsx(self, mock_load_xlsx):
        # Arrange
        loader = ExcelLoader("D:\\project\\mxRAG\\tests\\mx_rag\\document\\loader\\files\\test.xlsx")
        loader.load()
