...
class TestExcelLoader(unittest.TestCase):
    ...
    def test_load_xls(self):
        loader = ExcelLoader("./mx_rag/document/loader/files/test.xls")
        expect = [
            'None:中文资讯;source:机器之心;link:入门 | 机器之心 (jiqizhixin.com);count\n（3月15日为例）:9篇;SUM:24篇;--不需要订阅',
            'None:None;source:量子位;link:https://www.zhihu.com/org/liang-zi-wei-48/posts;count\n（3月15日为例）:4篇;'
            'SUM:None;--不需要订阅',
            'None:None;source:新智元;link:https://www.zhihu.com/org/xin-zhi-yuan-88-3;count\n（3月15日为例）:4篇;SUM:None;'
            '--不需要订阅',
            'None:None;source:极客公园;link:行业资讯 | 极客公园 (geekpark.net);count\n（3月15日为例）:7篇;SUM:None;--不需要订阅',
            'None:英文文献;source:huggingFace;link:日报 - 拥抱脸部 (huggingface.co);count\n（3月15日为例）:14篇;SUM:55篇;'
            '--不需要订阅',
            'None:None;source:PaperWithCode;link:带代码的最新论文 |带代码的论文 (paperswithcode.com);count\n'
            '（3月15日为例）:41篇;SUM:None;--不需要订阅']
        self.assertEqual(loader.load(), expect)
