...
class TestTextEmbedding(unittest.TestCase):
    ...
    def test_encode_success_fp16_mean(self,
                                      ...
                                      model_pre_mock,
                                      dir_check_mock):
        model_pre_mock.return_value = TestTextEmbedding.Model(1024)
        tok_pre_mock.return_value = TestTextEmbedding.Tokenizer()
    ...
    def test_encode_success_fp32_cls(self,
                                     ...
                                     model_pre_mock,
                                     dir_check_mock):
        model_pre_mock.return_value = TestTextEmbedding.Model(512)
        tok_pre_mock.return_value = TestTextEmbedding.Tokenizer()
