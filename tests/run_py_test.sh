...
export PYTHONPATH=$TOP_PATH:$PYTHONPATH:$GLIB_PATH:$FAKE_PACKAGE_PATH
...
function run_test_cases() {
    ...
    coverage xml -i --omit="build/*,cust_op/*,src/*,*/libs/*,${GLIB_PATH}/*,*/evaluate/*,*/train_data_generator.py,*/ops/*"
