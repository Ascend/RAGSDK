...
- 从哪里获取帮助
  ...
  - [RAG SDK API 参考](https://gitcode.com/Ascend/RAGSDK/blob/master/docs/zh/api/README.md)
  - [RAG SDK 文档](https://www.hiascend.com/document/detail/zh/mindsdk/730/rag/ragug/mxragug_0001.html)
...
- `{镜像名称}`:`{镜像tag}`：指定要运行的 RAG SDK 镜像和标签。
...
查看这些镜像中包含的 RAG SDK 和 Mind 系列软件的[许可证信息](https://gitcode.com/Ascend/RAGSDK/blob/master/LICENSE.md)。
