...
在开始安装部署前，建议先了解[前置知识](02-prerequisites.md)。
...
请参考《[CANN安装指南](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/900/softwareinst/instg/instg_0000.html)》安装昇腾NPU驱动和CANN软件（包含Toolkit和ops包），并配置环境变量。
